...
declare module "bsv" {
	export namespace crypto {
		...
		namespace ECDSA {
			...
			function verify(hashbuf: Buffer, sig: Signature, pubkey: PubKey, endian?: "little"): boolean;
		}
	...
	export class PrivKey {
		...
		static fromBuffer(buf: Buffer, network: string | Networks.Network): PrivKey;
		static fromHex(hex: string, network: string | Networks.Network): PrivKey;
	...
	export namespace Script {
		...
		function buildMultisigOut(publicKeys: PubKey[], threshold: number, opts: object): Script;
		function buildWitnessMultisigOutFromScript(script: Script): Script;
		function buildMultisigIn(pubkeys: PubKey[], threshold: number, signatures: Buffer[], opts: object): Script;
		function buildP2SHMultisigIn(pubkeys: PubKey[], threshold: number, signatures: Buffer[], opts: object): Script;
		function buildPublicKeyHashOut(address: Address): Script;
		function buildPublicKeyOut(pubkey: PubKey): Script;
		...
		function buildPublicKeyHashIn(publicKey: PubKey, signature: crypto.Signature | Buffer, sigtype: number): Script;
